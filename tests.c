...
START_TEST(test_s21_create_matrix_1) {
    matrix_t temp;
    ck_assert_int_eq(s21_create_matrix(-1, 3, &temp), INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(test_s21_sum_matrix) {
    ...
    ck_assert_int_eq(s21_sum_matrix(&temp, &temp2, &result), CORRECT_MATRIX);
...
START_TEST(test_s21_sub_matrix) {
    ...
    ck_assert_int_eq(s21_sub_matrix(&temp, &temp2, &result), CORRECT_MATRIX);
    ck_assert_int_eq(s21_eq_matrix(&result_defolt, &result), SUCCESS);
    s21_remove_matrix(&temp);
    s21_remove_matrix(&temp2);
    s21_remove_matrix(&result);
...
START_TEST(test_s21_mult_number) {
    ...
    ck_assert_int_eq(s21_mult_number(&temp, num, &result), CORRECT_MATRIX);
    ck_assert_int_eq(s21_eq_matrix(&result_defolt, &result), SUCCESS);
    s21_remove_matrix(&temp);
    s21_remove_matrix(&temp2);
    s21_remove_matrix(&result);
...
START_TEST(test_s21_mult_matrix_2) {
    ...
    ck_assert_int_eq(s21_mult_matrix(&temp, &temp2, &result), CORRECT_MATRIX);
    ck_assert_int_eq(s21_eq_matrix(&result_defolt, &result), SUCCESS);
    s21_remove_matrix(&temp);
    s21_remove_matrix(&temp2);
    s21_remove_matrix(&result);
...
START_TEST(test_s21_transpose) {
    ...
    ck_assert_int_eq(s21_transpose(&temp, &result), CORRECT_MATRIX);
    ck_assert_int_eq(s21_eq_matrix(&result_defolt, &result), SUCCESS);
    s21_remove_matrix(&temp);
    s21_remove_matrix(&result);
    s21_remove_matrix(&result_defolt);
...
START_TEST(test_s21_determinant) {
    ...
    ck_assert_int_eq(result_defolt, ERROR);
    s21_remove_matrix(&temp);
}
END_TEST
START_TEST(test_s21_determinant_1) {
    ...
    s21_gen_matrix(&temp);
    result_defolt = s21_determinant(&temp, &result);
    ck_assert_int_eq(result_defolt, CORRECT_MATRIX);
    s21_remove_matrix(&temp);
}
END_TEST
...
START_TEST(test_s21_inverse_matrix_2) {
    ...
    ck_assert_int_eq(result_status, ERROR);
    s21_remove_matrix(&temp);
}
END_TEST
...
START_TEST(test_s21_inverse_matrix_4) {
    ...
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            ck_assert_uint_eq(temp2.matrix[i][j],
            result.matrix[i][j]);
        }
    }
    s21_remove_matrix(&temp);
